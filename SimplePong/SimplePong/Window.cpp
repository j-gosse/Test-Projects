...
void Window::InitWindow()
{
	...
	// init renderer
	m_pRenderer = new Renderer(m_hWindow);
}
...
LRESULT Window::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CLOSE:
		...
		if (MessageBoxW(m_hWindow, L"Do you wish to exit?", L"Simple Pong", MB_OKCANCEL) == IDOK)
		{
			Window::Cleanup();
		}
		return 0;
...
ATOM Window::RegisterWindowClass()
{
	...
	m_windowClass.hIconSm = LoadIconW(m_hInstance, MAKEINTRESOURCE(IDI_SMALL));
